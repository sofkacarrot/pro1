...
fun MainScreen(){
    ...
    Column(
        modifier = Modifier
            .fillMaxSize().background(brush = Brush.linearGradient(colors = listOf(colorResource(R.color.pink),
...
@Composable
fun Preview(){
    ShoppingItemCard(ShoppingItem(100,"CFG","HF",1), onDeleteClicked = {}, onEditClicked = {})
}